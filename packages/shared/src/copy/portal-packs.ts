...
export const PORTAL_SEARCH_UX_COPY = {
  ...
  searchV2SessionBarHint: 'Tocá un chip para ajustar rápido.',
  ...
  searchV2GuidedActionsLabel: 'Seguí en un clic',
  searchV2CtaMoreOptions: 'Ver más opciones',
  searchV2CtaWiderPrice: 'Ampliar precio',
  searchV2CtaWholeCity: 'Toda la ciudad',
  ...
  searchV2EmptyTitle: 'No hay resultados con esta combinación',
  searchV2EmptyLine1: 'Ampliá el precio o buscá en toda la ciudad.',
  searchV2EmptyLine2: 'Si usás mapa, confirmá la zona o soltá el recorte.',
  searchV2EmptyLine3: 'Probá quitar el tipo o los amenities obligatorios.',
