...
echo "  - HTTP 401/429 o mensajes de quota en Vercel/Actions → cupo Hobby (deployments/día, minutos de build); ver docs/DEPLOY-CONTEXTO-AGENTES.md § Cuotas. No confundir con bug de código."
echo "  - Mails antiguos que citan «25 deploys/día»: pueden estar desactualizados respecto a la doc oficial de Vercel (hoy suele listarse 100/día en el plan Hobby)."
echo "Documentación: docs/DEPLOY-PASOS-URIs.md, docs/33-VERCEL-CONFIG-PROYECTO-WEB.md y docs/DEPLOY-CONTEXTO-AGENTES.md (§ Cuotas)"
