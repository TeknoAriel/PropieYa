...
export PROPIEYA_VERCEL_PANEL_PROJECT_NAME="${PROPIEYA_VERCEL_PANEL_PROJECT_NAME:-propieya-panel}"
export PROPIEYA_VERCEL_PANEL_PROJECT_ID="${PROPIEYA_VERCEL_PANEL_PROJECT_ID:-prj_Fzmr9YN25YEBHm0tk5gQ70VXmcKV}"
