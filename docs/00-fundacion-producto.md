...
| **Pasos** | 1. Desde panel B2B: "Nueva publicación". 2. Formulario guiado: tipo, operación, ubicación, precio, superficie, ambientes, descripción, amenities, imágenes. 3. Modo simple: campos esenciales. Modo pro: todos los campos. 4. Preview antes de publicar. 5. Al publicar: aviso queda activo con timer de 30 días. 6. A los 27 días: notificación "Tu aviso vence en 3 días. ¿Sigue disponible?". 7. Renovación en 1 click (o desde email). 8. Si no renueva: suspendido → notificación → archivado |
